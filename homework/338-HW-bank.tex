...
Transmission losses will be lower as we go to higher transmission
voltages since less current must be used for the same power transmission
at higher voltages.

Wiring costs are lowered in a home since not as much current must be
carried.
...
\subproblem If this lamp has a even illumination over all angles, what will the
...
\subproblem What is that illuminance in foot-candles on the desk surface? (2
pts)
...
\subproblem What is the total luminous flux in lumens from this lamp, assuming it
...
\subproblem What is the luminous intensity of the source in candela? (2 pts)
...
\subproblem If the upper hemisphere of the lighting fixture reflects light
...
\subproblem Assume kerosene costs 1 USD/liter.  Considering only the fuel cost,
