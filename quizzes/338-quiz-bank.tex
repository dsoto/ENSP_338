...
\solution{
The RMS current value is found from the apparent power, or the
hypotenuse of the power triangle.

$$ S \cdot PF = P = 3600W $$
$$ S = 3600W / 0.5 = 7200 VA $$

$$ I_{RMS} = S / V = 7200 VA / 120V = 60 A $$
...
\solution{
The current with a power factor of 0.5 is 60A.

If we change the power factor to 0.9, the apparent power will be

$$ S = 3600 W / 0.9 = 4000 VA $$

and the current will be

$$ I = 4000 VA / 120V = 33 A $$

The reduction is then 60A - 33A = 27A
}
